        ...
        <Box sx={style}>
          ...
          >
            <Grid container spacing={2}>
              ...
              {formik.values.file != "" ? (
                <Grid item xs={12} sm={12}>
                  Attached File : <a href={`${formik.values.file}`}>Download</a>
                </Grid>
              ) : null}
